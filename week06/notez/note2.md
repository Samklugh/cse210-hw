# W06 Team Activity: Eternal Quest Design
...
> ```
> GoalManager
>   Start()               - "main" function; called by Program.cs, runs the menu loop
>   DisplayPlayerInfo()   - Displays the players current score
>   ListGoalNames()       - Lists the names of each of the goals
>   ListGoalDetails()     - Lists the details of each goal (including the checkbox)
>   CreateGoal()          - Asks the user for goal info, creates and adds to the list
>   RecordEvent()         - Asks which goal was done, records the event
...
>   - Also sets _isComplete to false
>
...
>   - Also sets _amountCompleted to 0
>
> GoalManager()
>   - Initializes an empty list of goals and sets score to 0
> ```
...
- W06 Team Activity: Eternal Quest Design
- W06 Team Activity: Participation Report
