...
The code that determines the manager may end up returning either a base class Employee object or it may return an HourlyEmployee object. Regardless of the type of employee returned, the `manager.CalculatePay()` code will call the appropriate method.
